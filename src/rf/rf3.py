...
def calcular_vitorias_derrotas_por_temporada(team_id=1610612751, seasons=["2023-24", "2024-25"], output_dir="reports/arquivos_csv", img_dir="reports/imagens", html_dir="reports/graficos_html"):
    """
