...
def listar_times_conferencia(output_dir="reports/arquivos_csv", html_dir="reports/graficos_html", img_dir="reports/imagens"):
    """
    ...
    leste_html_path = os.path.join(html_dir, "rf1_tabela_times_leste.html")
    oeste_html_path = os.path.join(html_dir, "rf1_tabela_times_oeste.html")
    unificada_html_path = os.path.join(html_dir, "rf1_tabela_times_unificados.html")
