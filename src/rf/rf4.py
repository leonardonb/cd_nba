...
def calcular_totais_do_time(team_id=1610612751, seasons=["2023-24", "2024-25"], output_dir="reports/arquivos_csv", html_dir="reports/graficos_html", img_dir="reports/imagens"):
    """
    ...
    output_csv_path = os.path.join(output_dir, "rf4_totais_do_time_brooklyn_nets.csv")
    output_html_path = os.path.join(html_dir, "rf4_totais_do_time_brooklyn_nets.html")
    output_img_path = os.path.join(img_dir, "rf4_totais_do_time_brooklyn_nets.jpg")
